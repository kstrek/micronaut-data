 ...
 *
 * @see TransactionalClientSessionInterceptor
 * @see TransactionalClientSession
 */
@Retention(RUNTIME)
@Introduction
@Type(TransactionalClientSessionInterceptor.class)
@Internal
@interface TransactionalClientSessionAdvice {
}
