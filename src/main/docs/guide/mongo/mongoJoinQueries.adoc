As discussed in the previous section, Micronaut Data Mongo doesn't support associations in the traditional ORM sense. There is no lazy loading or support for proxies.
